<?php
/**
 * verdicts.php — Verdicts & Settlements. (SEO item 12)
 * Clean URL: /verdicts-and-settlements/
 * Required CA-Bar disclaimer at the TOP and BOTTOM.
 */
...
$page = [
    ...
    'path'        => '/verdicts-and-settlements/',
    'styles'      => ['/assets/css/home.css', '/assets/css/blog.css'],
    'breadcrumbs' => [
        ['name' => 'Home', 'path' => '/'],
        ['name' => 'Verdicts & Settlements', 'path' => '/verdicts-and-settlements/'],
    ],
];
